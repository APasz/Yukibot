...
def test_portal_restart_targets_exclude_host_reboot() -> None:
    targets = cmd_ops.available_restart_targets(config.BOT_PROFILES[config.BotProfileName.PORTAL])

    assert targets == (RestartTarget.BOT,)
