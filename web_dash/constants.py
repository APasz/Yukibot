...
_REMOTE_NODE_OVERVIEW_REQUEST_TIMEOUT_SECONDS: float = 4.0
_REMOTE_NODE_LONG_MUTATION_TIMEOUT_SECONDS: float = 10 * 60
_BULK_METADATA_OPERATION_POLL_SECONDS: float = 0.5
_MOD_UPDATE_CHECK_CACHE_TTL_SECONDS: float = 30 * 60
_MOD_UPDATE_CHECK_CACHE_MAX_ENTRIES: int = 512
_REMOTE_NODE_GET_MAX_ATTEMPTS: int = 2
_REMOTE_NODE_GET_RETRY_DELAY_SECONDS: float = 0.2
_MOD_WEB_APP_PAGE_RESPONSE_TIMEOUT_BUFFER_SECONDS: float = 5.0
_MOD_WEB_APP_PAGE_RESPONSE_TIMEOUT_SECONDS: float = (
    _REMOTE_NODE_GET_MAX_ATTEMPTS * _REMOTE_NODE_REQUEST_TIMEOUT_SECONDS
    + _REMOTE_NODE_GET_RETRY_DELAY_SECONDS
    + _MOD_WEB_APP_PAGE_RESPONSE_TIMEOUT_BUFFER_SECONDS
)
_REMOTE_NODE_CIRCUIT_BREAK_SECONDS: float = 15.0
_REMOTE_NODE_STREAM_CHUNK_SIZE_BYTES: int = 64 * 1024
_KNOWN_BOT_SNAPSHOT_CACHE_TTL_SECONDS: float = 5.0
...
_PORTAL_HEALTH_PATH: str = "/mod-web/health"
_PORTAL_NODE_LATENCIES_PATH: str = "/mod-web/portal-node-latencies"
_PORTAL_RECOVERY_HEALTH_TIMEOUT_SECONDS: float = 4.0
_PORTAL_RECOVERY_IDLE_THRESHOLD_SECONDS: float = 120.0
_PORTAL_RECOVERY_POLL_INTERVAL_SECONDS: float = 15.0
