...
class ModWebServiceSupport:
    ...
    @overload
    def __getattr__(self, name: Literal["_render_user_transfer_overlay"]) -> Callable[..., None]: ...
    ...
    @overload
    def __getattr__(self, name: Literal["_cached_mod_update_ids"]) -> Callable[..., frozenset[str]]: ...
    ...
    @overload
    def __getattr__(self, name: Literal["_pulse_live_value"]) -> Callable[..., None]: ...
    ...
    @overload
    def __getattr__(self, name: Literal["_set_element_visibility"]) -> Callable[..., None]: ...
    ...
    @overload
    def __getattr__(self, name: Literal["_system_bot_uptime_entry"]) -> Callable[..., tuple[str, BadgeTone]]: ...

    @overload
    def __getattr__(self, name: Literal["_system_ram_entry"]) -> Callable[..., tuple[str, BadgeTone]]: ...

    @overload
    def __getattr__(self, name: Literal["_system_ram_percent_entry"]) -> Callable[..., tuple[str, BadgeTone]]: ...

    @overload
    def __getattr__(self, name: Literal["_system_storage_entry"]) -> Callable[..., tuple[str, BadgeTone]]: ...

    @overload
    def __getattr__(self, name: Literal["_system_storage_percent_entry"]) -> Callable[..., tuple[str, BadgeTone]]: ...
